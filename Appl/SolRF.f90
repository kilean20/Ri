...
!        if(my_rank.eq.0) then
         !write(15,101)z,zz,zedge,ez1/1.0e6,ezp1/1.0e6,ezpp1/1.0e6
!         write(15,101)z,zz,zedge,ez1,ezp1,ezpp1
!        endif
...
!          print*,"zstart1: ",zstart1,zend1,zlc,numpar1
          if( (zlc.ge.zstart1-epslc).and.(zlc.le.zend1+epslc)) then
            zmid = zlength1/2
...
!          call flush_(10)
          ...
          if( (zlc.ge.zstart2-epslc) .and. (zlc.le.zend2+epslc)) then
            zmid = zlength2/2
...
!          print*,zlc,extfld
        ...
        !get external field without displacement and rotation errors.
        subroutine  getfldarray_SolRF(zin,phi0,pts,extfld,this,nplc)
        implicit none
        include 'mpif.h'
        ...
        zlength1 = Fcoef(4)
        extfld = 0.0
!          print*,"zstart1: ",zstart1,zend1,zlc,numpar1,phi0
        if( (zlc.ge.zstart1-epslc).and.(zlc.le.zend1+epslc)) then
            zmid = zlength1/2
          ...
          ezpp1=ezpp1*escale
          ezppp = ezppp*escale
!          write(10,*)zin,zlc,ez1,ezp1,ezpp1,ezppp
...
!          print*,"strange",zlc,ez1,ezp1,ezpp1,tmpez,tmpcos,tmpsin,ww,tt,theta0
!          write(11,101)pos(3),zlc,ez1,ezp1,ezpp1,tmpez,tmpcos,tmpsin,tt,theta0
!101       format(10(1x,e14.5))
!          call flush_(10)
...
!            call flush_(11)
        ...
        end subroutine getfldarray_SolRF
