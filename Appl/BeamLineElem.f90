...
!          private
      ...
      contains
        ...
        function assign_nll(tnll) result(ppnll)
        type (BeamLineElem) :: ppnll
        type (NonlinearLens), target, intent(in) :: tnll

        ppnll%pnll => tnll
        nullify(ppnll%psl)
        nullify(ppnll%pbpm)   
        nullify(ppnll%pquad)
        nullify(ppnll%pdrift)
        nullify(ppnll%pccl)
        nullify(ppnll%pccdtl)
        nullify(ppnll%pdtl)
        nullify(ppnll%psc)
        nullify(ppnll%pcf)
        nullify(ppnll%pslrf)
        nullify(ppnll%pdipole)
