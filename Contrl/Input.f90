...
!        use mpistub
      ...
      contains
        ...
        implicit none
        include 'mpif.h'
        integer, intent(out) :: odim,onx,ony,onz,oflagbc,oflagdist
        integer*8, intent(out) :: onp
...
123       continue
  ...
  789     continue
        ...
        call MPI_BCAST(onptmp,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr)
        onp = onptmp
        ...
        call MPI_BCAST(onptlisttmp(1),onchrg,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr)
        onptlist = onptlisttmp
